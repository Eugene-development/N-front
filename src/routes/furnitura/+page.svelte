		...
		<div class="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
			<nav class="flex" aria-label="Breadcrumb">
				<ol class="flex items-center space-x-2 text-sm">
					...
					<li>
						<span class="text-slate-900 font-medium">Фурнитура</span>
					</li>
				</ol>
			</nav>
		</div>
			...
			<aside class="hidden lg:block">
				<div class="sticky top-24">
					<nav class="space-y-1">
						...
						<a href="/furnitura/petli" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Петли</span>
						</a>

						<a href="/furnitura/napravlyayushchie" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Направляющие</span>
						</a>

						<a href="/furnitura/podyomniki" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Подъёмные механизмы</span>
						</a>

						<a href="/furnitura/ruchki" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Ручки</span>
						</a>

						<a href="/furnitura/sistemy-hraneniya" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Системы хранения</span>
						</a>

						<a href="/furnitura/osveshchenie" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Освещение</span>
						</a>
					</nav>

					<!-- Баннер -->
					<div class="mt-8 rounded-2xl bg-gradient-to-br from-slate-700 to-slate-900 p-6 text-white">
						...
						<a href="/consultation" class="mt-4 inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-sm font-medium text-slate-800 transition-all hover:bg-slate-100">
							Узнать цены
			...
			<main class="lg:col-span-3">
				...
				<div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-slate-800">
					...
					<div class="relative px-8 py-16 sm:px-12 sm:py-20">
						...
						<p class="mt-4 max-w-xl text-lg text-slate-300">
							Качественная мебельная фурнитура от мировых лидеров. 
							Петли с доводчиками, направляющие полного выдвижения, подъёмные механизмы.
						</p>
						<div class="mt-8 flex flex-wrap gap-4">
							<a href="/consultation" class="inline-flex items-center gap-2 rounded-lg bg-amber-500 px-6 py-3 font-medium text-white transition-all hover:bg-amber-600">
								Подобрать фурнитуру
								<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
								</svg>
							</a>
							<a href="/mebel" class="inline-flex items-center gap-2 rounded-lg bg-white/10 px-6 py-3 font-medium text-white backdrop-blur transition-all hover:bg-white/20">
								Каталог мебели
							</a>
						</div>
					</div>
				...
				<div class="mt-8 lg:hidden">
					...
					<div class="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3">
						<a href="/furnitura/petli" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-100 text-amber-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Петли</span>
						</a>
						<a href="/furnitura/napravlyayushchie" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-100 text-sky-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Направляющие</span>
						</a>
						<a href="/furnitura/podyomniki" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-violet-100 text-violet-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 10l7-7m0 0l7 7m-7-7v18" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Подъёмники</span>
						</a>
						<a href="/furnitura/ruchki" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-100 text-emerald-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Ручки</span>
						</a>
						<a href="/furnitura/sistemy-hraneniya" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-cyan-100 text-cyan-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Хранение</span>
						</a>
						<a href="/furnitura/osveshchenie" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-yellow-100 text-yellow-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Освещение</span>
						</a>
					</div>
				</div>
				...
				<div class="mt-12">
					...
					<div class="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
						<div class="flex h-24 flex-col items-center justify-center rounded-xl bg-white p-4 shadow-sm">
				...
				<div class="mt-12">
					...
					<div class="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
						<div class="rounded-xl bg-white p-6 shadow-sm">
							...
							<p class="mt-2 text-sm text-slate-600">Плавное закрывание дверей без хлопка. Clip-top, Sensys, Intermat</p>
						</div>
						...
						<div class="rounded-xl bg-white p-6 shadow-sm">
							...
							<p class="mt-2 text-sm text-slate-600">Полное выдвижение, плавное закрывание. Tandem, Quadro, ArciTech</p>
						</div>
						...
						<div class="rounded-xl bg-white p-6 shadow-sm">
							...
							<p class="mt-2 text-sm text-slate-600">Aventos HK, HF, HL для верхних шкафов. Лёгкое открывание</p>
						</div>
					</div>
				</div>
				...
				<div class="mt-12">
					...
					<div class="mt-6 grid gap-6 sm:grid-cols-2">
						<a href="/furnitura/napravlyayushchie" class="group relative overflow-hidden rounded-2xl">
							<img
				...
				<div class="mt-12">
					...
					<div class="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
						<div class="rounded-xl bg-white p-6 shadow-sm">
							...
							<p class="mt-2 text-sm text-slate-600">Гарантия от производителя до 25 лет. Более 100 000 циклов открывания</p>
						</div>

						<div class="rounded-xl bg-white p-6 shadow-sm">
							<div class="flex h-12 w-12 items-center justify-center rounded-xl bg-sky-100 text-sky-600">
								<svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15.536a5 5 0 001.414 1.414m2.828-9.9a9 9 0 0112.728 0" />
								</svg>
							</div>
							<h3 class="mt-4 text-lg font-semibold text-slate-900">Тишина</h3>
							<p class="mt-2 text-sm text-slate-600">Системы плавного закрывания — никаких хлопков и шума</p>
						</div>
						...
						<div class="rounded-xl bg-white p-6 shadow-sm">
							...
							<p class="mt-2 text-sm text-slate-600">Электропривод Servo-Drive — открывание лёгким касанием</p>
						</div>
					</div>
				</div>
						...
						<table class="w-full text-left text-sm">
							...
							<tbody class="divide-y divide-slate-100">
								...
								<tr>
									...
									<td class="px-4 py-3"><span class="rounded-full bg-emerald-100 px-2 py-1 text-xs font-medium text-emerald-700">Servo-Drive</span></td>
									<td class="px-4 py-3"><span class="rounded-full bg-emerald-100 px-2 py-1 text-xs font-medium text-emerald-700">Push to Open</span></td>
									<td class="px-4 py-3"><span class="rounded-full bg-emerald-100 px-2 py-1 text-xs font-medium text-emerald-700">Kinvaro</span></td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<!-- CTA секция -->
				<div class="mt-12 rounded-2xl bg-gradient-to-r from-slate-800 to-slate-900 p-8 text-center text-white sm:p-12">
