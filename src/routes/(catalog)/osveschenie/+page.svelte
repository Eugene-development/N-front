<script>
	...
	const shopGradients = [
		{ from: 'from-amber-100', to: 'to-yellow-100', hover: 'group-hover:from-amber-500 group-hover:to-yellow-500', text: 'text-amber-600', bg: 'bg-amber-500' },
...
<svelte:head>
	<title>Освещение – Магазины и поставщики | Компания Новострой</title>
	<meta
		name="description"
		content="Каталог онлайн-магазинов освещения для интерьеров и экстерьеров. Люстры, бра, торшеры, LED-подсветка, уличное освещение от лучших поставщиков."
	/>
</svelte:head>
	...
	<div class="mx-auto max-w-screen-2xl px-4 py-14 sm:px-6 lg:px-8">
		<div class="lg:grid lg:grid-cols-4 lg:gap-8">
			...
			<main class="lg:col-span-3">
				...
				>
					<img
						src="/lighting_hero.png"
						alt="Освещение для интерьеров и экстерьеров"
						class="absolute inset-0 h-full w-full object-cover opacity-40"
					/>
					<div class="relative px-8 py-16 sm:px-12 sm:py-20">
						<h1 class="text-3xl font-bold text-white sm:text-4xl lg:text-5xl">Освещение</h1>
						<p class="mt-4 max-w-xl text-lg text-slate-300">
							Каталог интернет-магазинов и поставщиков освещения. Люстры, бра, торшеры,
							LED-подсветка, уличное и ландшафтное освещение от проверенных партнёров.
						</p>
				...
				<div class="mt-12">
					...
					{#if shops.length === 0}
						<div class="mt-6 rounded-xl bg-white p-12 text-center shadow-sm">
							...
							<p class="mt-2 text-slate-500">Скоро здесь появятся магазины освещения</p>
						</div>
					{:else}
				...
				>
					...
					<p class="mx-auto mt-3 max-w-md text-slate-300">
						Поможем выбрать оптимальное решение для интерьерного и экстерьерного освещения с учётом
						бюджета и стиля
					</p>
