				...
				<div class="sticky top-24">
					<nav class="space-y-1">
						...
						<a href="/tehnika/varochnye-paneli" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							<span class="flex h-10 w-10 items-center justify-center rounded-lg bg-linear-to-br from-red-100 to-orange-100 text-red-600 transition-all group-hover:from-red-500 group-hover:to-orange-500 group-hover:text-white group-hover:shadow-lg">
