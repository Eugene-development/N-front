		...
		<div class="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
			<nav class="flex" aria-label="Breadcrumb">
				<ol class="flex items-center space-x-2 text-sm">
					...
					<li>
						<span class="text-slate-900 font-medium">Аксессуары</span>
					</li>
				</ol>
			</nav>
		</div>
				...
				<div class="sticky top-24">
					<nav class="space-y-1">
						...
						<a href="/aksessuary/reylingi" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Рейлинги</span>
						</a>
						...
						<a href="/aksessuary/organajzery" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Органайзеры для ящиков</span>
						</a>
						...
						<a href="/aksessuary/korziny" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Выдвижные корзины</span>
						</a>
						...
						<a href="/aksessuary/sushki" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Сушки для посуды</span>
						</a>
						...
						<a href="/aksessuary/musor" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Системы сортировки мусора</span>
						</a>
						...
						<a href="/aksessuary/podsvetka" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Подсветка</span>
						</a>
						...
						<a href="/aksessuary/kryuchki" class="group flex items-center gap-3 rounded-xl px-4 py-3 text-slate-700 transition-all hover:bg-white hover:shadow-md hover:text-sky-600">
							...
							<span class="font-medium">Крючки и держатели</span>
						</a>
					</nav>
			...
			<main class="lg:col-span-3">
				...
				<div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-slate-800">
					...
					<div class="relative px-8 py-16 sm:px-12 sm:py-20">
						...
						<p class="mt-4 max-w-xl text-lg text-slate-300">
							Функциональные аксессуары для организации кухонного пространства. 
							Рейлинги, органайзеры, корзины и системы хранения.
						</p>
						<div class="mt-8 flex flex-wrap gap-4">
							<a href="/consultation" class="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-6 py-3 font-medium text-white transition-all hover:bg-emerald-600">
				...
				<div class="mt-8 lg:hidden">
					...
					<div class="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3">
						<a href="/aksessuary/reylingi" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 6h16M4 12h16M4 18h16" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Рейлинги</span>
						</a>
						<a href="/aksessuary/organajzery" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-100 text-sky-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Органайзеры</span>
						</a>
						<a href="/aksessuary/korziny" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-100 text-amber-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Корзины</span>
						</a>
						<a href="/aksessuary/sushki" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-100 text-emerald-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Сушки</span>
						</a>
						<a href="/aksessuary/musor" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-violet-100 text-violet-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Мусор</span>
						</a>
						<a href="/aksessuary/podsvetka" class="flex items-center gap-2 rounded-xl bg-white p-3 shadow-sm transition-all hover:shadow-md">
							<span class="flex h-8 w-8 items-center justify-center rounded-lg bg-yellow-100 text-yellow-600">
								<svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
								</svg>
							</span>
							<span class="text-sm font-medium text-slate-700">Подсветка</span>
						</a>
					</div>
				</div>
				...
				<div class="mt-12">
					...
					<div class="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
						<div class="rounded-xl bg-white p-6 shadow-sm">
							...
							<p class="mt-2 text-sm text-slate-600">Разделители для столовых приборов, специй и кухонных принадлежностей</p>
						</div>
						...
						<div class="rounded-xl bg-white p-6 shadow-sm">
							...
							<p class="mt-2 text-sm text-slate-600">Выдвижные корзины для бутылок, банок и продуктов</p>
						</div>
						...
						<div class="rounded-xl bg-white p-6 shadow-sm">
							...
							<p class="mt-2 text-sm text-slate-600">Выдвижные системы для угловых шкафов с полным доступом</p>
						</div>
					</div>
				</div>
					...
					<div class="lg:flex lg:items-center lg:gap-8">
						<div class="lg:flex-1">
							...
							<p class="mt-3 text-slate-600">
								Закажите кухню с полным набором аксессуаров — органайзеры, корзины, сушки и системы хранения со скидкой до 15%.
							</p>
						...
						<div class="mt-6 lg:mt-0">
							<a href="/furniture-project" class="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-6 py-3 font-medium text-white transition-all hover:bg-emerald-600">
								Заказать проект
								<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
								</svg>
				...
				<div class="mt-12 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 p-8 text-center text-white sm:p-12">
					...
					<div class="mt-6 flex flex-wrap justify-center gap-4">
						<a href="/consultation" class="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 font-medium text-emerald-600 transition-all hover:bg-emerald-50">
							Получить консультацию
						</a>
