...
<div
	class="relative isolate animate-fade bg-white py-12 animate-duration-500 animate-ease-in-out sm:py-32"
>
	<div
	...
	>
		<div
			class="ml-[max(50%,38rem)] aspect-[1313/771] w-[82.0625rem] bg-linear-to-tr from-[#ff80b5] to-[#9089fc]"
	...
	>
		<div
			class="ml-[-22rem] aspect-[1313/771] w-[82.0625rem] flex-none origin-top-right rotate-[30deg] bg-linear-to-tr from-[#ff80b5] to-[#9089fc] xl:ml-0 xl:mr-[calc(50%-12rem)]"
			style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
		></div>
	</div>
			...
			>
				...
				>
					<p>
						...
						кухне стал очень хорошим дополнением к интерьеру. Большое спасибо за вашу работу!
					</p>
				</blockquote>
				<figcaption
					...
					<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
						<blockquote class="text-gray-900">
							<p>
								...
								проводим вместе с семьёй. Обновка моя удалась! Спасибочки)
							</p>
						</blockquote>
						<figcaption class="mt-6 flex items-center gap-x-4">
							<div>
					...
					<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
						<blockquote class="text-gray-900">
							<p>
								...
								в рассрочку, так как не уложились в свой бюджет.
							</p>
						</blockquote>
						<figcaption class="mt-6 flex items-center gap-x-4">
							<div>
					...
					<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
						<blockquote class="text-gray-900">
							<p>
								...
								подходит, ничего не смущает даже. В идеале сроки бы конечно покороче сделать.
							</p>
						</blockquote>
						<figcaption class="mt-6 flex items-center gap-x-4">
							<div>
					...
					<figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
						<blockquote class="text-gray-900">
							<p>
								...
								хорошо что вы успели к моему Дню рождения!
							</p>
						</blockquote>
						<figcaption class="mt-6 flex items-center gap-x-4">
							<div>
