...
<section class="relative overflow-hidden bg-gray-900 py-24 sm:py-32">
	...
	<div class="relative mx-auto max-w-7xl px-6 text-center lg:px-8">
		...
		<p class="mx-auto mt-6 max-w-2xl text-lg/8 text-gray-300">
			Мы работаем с понедельника по субботу с 10:00 до 20:00 по Москве. В иное время воспользуйтесь
			онлайн-чатом или почтой.
		</p>
	</div>
</section>
...
<section class="bg-white py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="grid gap-8 lg:grid-cols-3">
			<!-- Телефон -->
			<div
				class="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg ring-1 ring-gray-200 transition duration-300 hover:-translate-y-2 hover:shadow-2xl hover:ring-sky-500"
			>
				<div
					class="absolute -right-4 -top-4 size-24 rounded-full bg-sky-500/10 transition duration-300 group-hover:scale-150"
				></div>
				<div class="relative">
					<div
						class="flex size-14 items-center justify-center rounded-2xl bg-sky-500 text-white shadow-lg shadow-sky-500/30"
					>
						<svg
							class="size-7"
							fill="none"
					...
					<a
						...
						class="mt-6 inline-flex items-center gap-2 text-lg font-semibold text-sky-600 transition hover:text-sky-500"
					>
						8 (915) 400-00-20
						<svg
							class="size-4"
			...
			>
				...
				<div class="relative">
					...
					<p class="mt-3 text-base/7 text-gray-600">
						Напишите нам, и мы обязательно ответим в течение 24 часов
					</p>
					<a
				...
				<div class="relative">
					...
					<p class="mt-6 inline-flex items-center gap-2 text-lg font-semibold text-sky-600">
						...
						<span class="relative flex size-3">
							<span
								class="absolute inline-flex size-full animate-ping rounded-full bg-sky-400 opacity-75"
							></span>
...
<section class="bg-gray-50 py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="grid items-center gap-16 lg:grid-cols-2">
			...
			<div>
				<p class="text-base/7 font-semibold text-sky-600">Давайте встретимся</p>
				<h2
					class="mt-2 text-pretty text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl"
				>
					Личная консультация
				</h2>
				<p class="mt-6 text-lg/8 text-gray-600">
					Мы можем организовать с вами встречу всалоне наших партнёров или в любом удобном для вас
					месте.
				</p>
				...
				<dl class="mt-10 space-y-6">
					<div class="flex gap-4">
						...
						<dd>
							<p class="font-semibold text-gray-900">Адреса салонов</p>
					...
					<div class="flex gap-4">
						...
						<dd>
							...
							<p class="mt-1 text-base/7 text-gray-600">Уточните наличие бесплатной парковки</p>
						</dd>
					</div>
				</dl>
			</div>
				...
				<div class="relative overflow-hidden rounded-3xl bg-gray-200 shadow-2xl">
					...
					<div class="flex aspect-square items-center justify-center bg-gray-100">
						<div class="text-center">
							<svg
								class="mx-auto size-16 text-gray-400"
								fill="none"
								viewBox="0 0 24 24"
								stroke="currentColor"
								stroke-width="1"
...
<section class="bg-white py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		...
		<div class="mt-16 flex flex-wrap justify-center gap-6">
			...
			>
				<div
					class="flex size-14 items-center justify-center rounded-2xl transition duration-300 group-hover:scale-110"
				>
					<img
			...
			>
				<div
					class="flex size-14 items-center justify-center rounded-2xl bg-sky-500 text-white transition duration-300 group-hover:scale-110"
				>
			...
			>
				<div
					class="flex size-14 items-center justify-center rounded-2xl bg-blue-600 text-white transition duration-300 group-hover:scale-110"
				>
					<svg class="size-8" fill="currentColor" viewBox="0 0 24 24">
						<path
...
<section class="relative overflow-hidden bg-gray-900 py-24 sm:py-32">
	...
	<div class="relative mx-auto max-w-3xl px-6 text-center lg:px-8">
		...
		<p class="mx-auto mt-6 max-w-xl text-lg/8 text-gray-400">
			Свяжитесь с нами любым удобным способом — мы всегда рады помочь с выбором мебели и дизайном
			интерьера
		</p>
