...
<svelte:head>
	...
	<meta
		name="description"
		content="Компания Новострой — более 24 лет профессиональных услуг в сфере мебельной индустрии. 358 партнёрских салонов, 17 городов России, 4000+ реализованных проектов."
	/>
</svelte:head>
	...
	<div class="relative overflow-hidden bg-linear-to-br from-slate-900 via-slate-800 to-sky-900">
		...
		<div class="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
			<div class="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
				<div>
					<div
						class="inline-flex items-center rounded-full bg-sky-500/10 px-4 py-2 text-sm font-medium text-sky-400 backdrop-blur"
					>
		...
		<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
			...
			>
				...
				<div class="relative">
					...
					<div
						class="mt-4 h-1 w-12 rounded-full bg-linear-to-r from-violet-500 to-purple-500"
					></div>
				</div>
			</div>
			<div
	...
	<div class="bg-slate-50 py-24">
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="text-center">
				<h2 class="text-3xl font-bold text-slate-900">Наши ценности</h2>
			...
			<div class="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
				<div class="flex items-start gap-4">
					...
					<div>
						<h3 class="text-lg font-semibold text-slate-900">Качество</h3>
						<p class="mt-2 text-slate-600">
							Работаем только с проверенными поставщиками и фабриками.
						</p>
					</div>
				</div>
				...
				<div class="flex items-start gap-4">
					...
					<div>
						<h3 class="text-lg font-semibold text-slate-900">Клиентоориентированность</h3>
						<p class="mt-2 text-slate-600">
							Каждый проект уникален, и мы учитываем все пожелания клиента.
						</p>
					</div>
				</div>
				...
				<div class="flex items-start gap-4">
					...
					<div>
						<h3 class="text-lg font-semibold text-slate-900">Инновации</h3>
						<p class="mt-2 text-slate-600">Следим за трендами и внедряем современные технологии.</p>
					</div>
				</div>
				...
				<div class="flex items-start gap-4">
					...
					<div>
						<h3 class="text-lg font-semibold text-slate-900">Забота</h3>
						<p class="mt-2 text-slate-600">
							Создаём пространства, которые вдохновляют и радуют каждый день.
						</p>
					</div>
				</div>
				...
				<div class="flex items-start gap-4">
					...
					<div>
						<h3 class="text-lg font-semibold text-slate-900">Доступность</h3>
						<p class="mt-2 text-slate-600">
							Работаем в 17 городах России и постоянно расширяем географию.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="text-center">
				...
				<p class="mx-auto mt-4 max-w-2xl text-slate-300">
					Преимущества работы с компанией Новострой
				</p>
			</div>
			...
			<div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
				<div class="rounded-2xl bg-white/5 p-6 backdrop-blur transition-all hover:bg-white/10">
					<div
						class="flex h-12 w-12 items-center justify-center rounded-xl bg-sky-500/20 text-sky-400"
					>
						<svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path
								stroke-linecap="round"
					...
					<h3 class="mt-4 text-lg font-semibold text-white">Гарантия до 10 лет</h3>
					<p class="mt-2 text-sm text-slate-400">
						Расширенная гарантия на все виды продукции наших партнёров
					</p>
				</div>

				<div class="rounded-2xl bg-white/5 p-6 backdrop-blur transition-all hover:bg-white/10">
					<div
						class="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-500/20 text-emerald-400"
					>
						<svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path
								stroke-linecap="round"
					...
					<h3 class="mt-4 text-lg font-semibold text-white">Рассрочка 0%</h3>
					<p class="mt-2 text-sm text-slate-400">Удобные условия оплаты без переплат и комиссий</p>
				</div>

				<div class="rounded-2xl bg-white/5 p-6 backdrop-blur transition-all hover:bg-white/10">
					<div
						class="flex h-12 w-12 items-center justify-center rounded-xl bg-violet-500/20 text-violet-400"
					>
						<svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path
								stroke-linecap="round"
				...
				<div class="rounded-2xl bg-white/5 p-6 backdrop-blur transition-all hover:bg-white/10">
					<div
						class="flex h-12 w-12 items-center justify-center rounded-xl bg-amber-500/20 text-amber-400"
					>
						<svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path
								stroke-linecap="round"
					...
					<h3 class="mt-4 text-lg font-semibold text-white">Доставка и монтаж</h3>
					<p class="mt-2 text-sm text-slate-400">Профессиональная сборка и установка "под ключ"</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="bg-white py-24">
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="text-center">
				...
				<p class="mx-auto mt-4 max-w-2xl text-slate-600">Примеры реализованных проектов</p>
			</div>
			...
			<div class="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
				<div class="group relative overflow-hidden rounded-2xl">
					...
					/>
					<div
						class="absolute inset-0 bg-linear-to-t from-slate-900/80 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100"
					></div>
					<div
						class="absolute bottom-0 left-0 right-0 p-6 text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100"
					>
