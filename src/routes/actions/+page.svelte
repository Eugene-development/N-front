...
<section class="bg-gray-50 py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
			<!-- Карточка 7 -->
			<div class="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg ring-1 ring-gray-200 transition duration-300 hover:-translate-y-2 hover:shadow-2xl hover:ring-amber-500">
				<div class="absolute -right-4 -top-4 size-24 rounded-full bg-amber-500/10 transition duration-300 group-hover:scale-150"></div>
				<div class="relative">
					<div class="flex size-14 items-center justify-center rounded-2xl bg-amber-500 text-white shadow-lg shadow-amber-500/30">
						<svg class="size-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
...
<section class="bg-white py-24 sm:py-32">
	<div class="mx-auto max-w-3xl px-6 text-center lg:px-8">
		...
		<div class="mt-10">
			<a href="/contacts" class="inline-flex items-center gap-2 rounded-lg bg-red-500 px-8 py-4 text-sm font-semibold text-white shadow-lg shadow-red-500/30 transition duration-300 hover:-translate-y-1 hover:bg-red-400 hover:shadow-xl hover:shadow-red-500/40">
				Связаться с нами
		...
		<p class="mt-8 text-sm text-gray-500">
			Или позвоните: <a href="tel:+79154000020" class="text-red-500 transition hover:text-red-400">8 (915) 400-00-20</a>
		</p>
	</div>
</section>
