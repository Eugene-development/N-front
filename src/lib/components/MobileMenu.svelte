			...
			<nav class="space-y-1">
				...
				<div class="mt-4 border-t border-slate-100 pt-4">
					...
					<a
						...
						class="flex items-center gap-3 rounded-xl px-4 py-3 transition-colors duration-200 hover:bg-sky-50"
					>
						<div
							class="flex h-10 w-10 items-center justify-center rounded-lg bg-linear-to-br from-sky-100 to-blue-100 text-sky-600"
						>
						...
						<span class="text-base font-semibold text-slate-900">Партнёрство</span>
					</a>
