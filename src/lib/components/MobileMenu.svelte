			...
			<nav class="space-y-1">
				...
				<div class="overflow-hidden rounded-xl">
					...
					>
						...
						<svg
							class="h-5 w-5 text-slate-400 transition-transform duration-300 {showServiceMenu ? 'rotate-180 text-pink-500' : ''}"
							fill="none"
							viewBox="0 0 24 24"
							stroke="currentColor"
						>
				...
				<div class="overflow-hidden rounded-xl">
					...
					>
						...
						<svg
							class="h-5 w-5 text-slate-400 transition-transform duration-300 {showCatalogMenu ? 'rotate-180 text-violet-500' : ''}"
							fill="none"
							viewBox="0 0 24 24"
							stroke="currentColor"
						>
				...
				<div class="overflow-hidden rounded-xl">
					...
					>
						...
						<svg
							class="h-5 w-5 text-slate-400 transition-transform duration-300 {showInformationMenu ? 'rotate-180 text-sky-500' : ''}"
							fill="none"
							viewBox="0 0 24 24"
							stroke="currentColor"
						>
				...
				<div class="mt-4 border-t border-slate-100 pt-4">
					...
					>
						...
						<span class="ml-auto flex h-5 items-center rounded-full bg-pink-500 px-2 text-xs font-medium text-white">NEW</span>
					</a>
