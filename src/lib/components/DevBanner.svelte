...
{#if isVisible}
	<div
		class="relative bg-linear-to-r from-amber-500 via-orange-500 to-amber-500 px-4 py-2 transition-all duration-300"
	...
	>
		...
		<div class="relative mx-auto flex max-w-7xl items-center justify-between gap-x-4">
			...
			<div class="flex items-center gap-x-3">
				<div
					class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm"
				>
					<svg
				...
				<div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-2">
					<p class="text-sm font-semibold text-white">Сайт находится в разработке</p>
